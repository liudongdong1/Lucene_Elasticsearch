...
{
    private static final Logger2 log = LoggerFactory2.getLogger(JdbcUtil.class);//日志对象
    ...
    public JdbcUtil()
    {
        String url="jdbc:mysql://localhost:3306/mysql?useUnicode=true&characterEncoding=UTF-8&characterSetResults=utf8&serverTimezone=GMT";
        String user="root";
        String password="199611@liu";
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        String  code ="1";
        ResultSet rs = jdbc.query("select * from blog where `id`=? ", code);
        while(rs.next())
        {
            System.out.println(rs.getInt("id"));
            System.out.println(rs.getString("title"));
            System.out.println(rs.getString("tags"));
            System.out.println(rs.getString("url"));//注意索引从1开始
        }
        jdbc.closeAll();
    }
}
